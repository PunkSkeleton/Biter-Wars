data:extend({
	    ...
	    icons = {
	      {
	        icon = "__biter-wars__/graphics/biter-upgrade.png",
	        icon_size = 256,
	        icon_mipmaps = 1,
	      }
	    },
	  ...
	  },
	  {
	    ...
	    icons = {
	      {
	        icon = "__biter-wars__/graphics/spitter-upgrade.png",
	        icon_size = 256,
	        icon_mipmaps = 1,
	      }
	    },
	  ...
	  },
	  {
	    ...
	    icons = {
	      {
	        icon = "__biter-wars__/graphics/biter.png",
	        icon_size = 256,
	        icon_mipmaps = 1,
	      },
	    },
	  ...
	  },
	  {
	    ...
	    icons = {
	      {
	        icon = "__biter-wars__/graphics/spitter.png",
	        icon_size = 256,
	        icon_mipmaps = 1,
	      }
	    },
