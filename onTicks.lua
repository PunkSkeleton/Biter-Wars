function onTick()	
	...
	if global["aiRootActive"] then
		...
		profiler3.stop()
		game.write_file("biter-wars.log", "onTick with ai step" .. global["aiStep"] .. " took: ", true)
		game.write_file("biter-wars.log", {"", profiler3}, true)
...
function on300thtick(event)
	...
	profiler2.stop()
	game.write_file("biter-wars.log", "on300thtick took: ", true)
	game.write_file("biter-wars.log", {"", profiler2}, true)
	game.write_file("biter-wars.log", "\n", true)
	profiler2.reset()
end